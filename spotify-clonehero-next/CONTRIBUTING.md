# Contributing to spotify-clonehero-next

This repository hosts a Next.js **App Router** application. The codebase uses **TypeScript**, **React Server Components**, **Shadcn UI (Radix + Tailwind)** and absolute imports via the `@` alias.

These guidelines document the project's conventions to ensure consistency.
